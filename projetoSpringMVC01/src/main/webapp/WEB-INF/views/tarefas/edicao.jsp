...
<body>
	...
	<div class="container mt-3">
		...
		<form id="form-edicao" action="atualizar-tarefa" method="post" autocomplete="off">
			...
			<div class="row mt-3">
				...
				<div class="col-md-3">
					...
					<form:select path="tarefas-dto.prioridade" class="form-select" id="prioridade" name="prioridade">
